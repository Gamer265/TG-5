...
class Development(Config):
    ...
    FROM_CHATS = [-1001519007225,-1001209629928,-1001217338584,-1001368524326,-1001471322747,-1001519628670,-1001505402139,-1001668681402,-1001372142453]# List of chat id's to forward messages from.
